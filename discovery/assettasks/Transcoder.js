...
function Transcoder(asset, cb, config) {
    ...
    switch ( asset.assetType) {
        case "video":
            var infile = config.mediaDirectory + path.sep + asset.filename;
            var outfile = config.mediaDirectory + path.sep + FileUtils.prototype.removeExtension(asset.filename)+".mp3";
