...
function MediaFinder (config) {
    ...
    this._mp3RegEx = /(https?:\/\/+[\w\d:#@%/;$()~_?\+-=\\\.&]*\.mp3)/gi;
    this._youtubeRegex = /https?:\/\/(www)?.youtube.com\/(embed\/)?(watch\?v=)?[A-Za-z0-9\-\_]*/gi;
    this._vimeoRegex = /https?:\/\/(www.)?player.vimeo.com\/video\/[A-Za-z0-9\-\_]*/gi;
    this._soundcloudRegex = /http:\/\/w.soundcloud.com\/player\/\?url=http%3A%2F%2Fapi.soundcloud.com%2Ftracks%2F[A-Za-z0-9\-\_]*/gi;
